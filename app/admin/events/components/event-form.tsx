  ...
  const form = useForm<EventFormValues>({
    ...
    defaultValues: event
      ? {
          ...
          strictAttendance: event.strictAttendance,
          type: event.type,
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Duration or end time (e.g., &quot;3 hours&quot;,
                        &quot;2024-12-31 18:00&quot;)
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value={EventType.CONTEST}>
                          Contest
                        </SelectItem>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value={ParticipationScope.OPEN_FOR_ALL}>
                          Open for All
                        </SelectItem>
                        <SelectItem value={ParticipationScope.ONLY_GIRLS}>
                          Only Girls
                        </SelectItem>
                        <SelectItem
                          value={ParticipationScope.JUNIOR_PROGRAMMERS}
                        >
                          Junior Programmers
                        </SelectItem>
                        <SelectItem value={ParticipationScope.SELECTED_PERSONS}>
                          Selected Persons
                        </SelectItem>
                      </SelectContent>
                    </Select>
