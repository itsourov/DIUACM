...
import { Event, Visibility, EventType, AttendanceScope } from "@prisma/client";
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        {Object.values(AttendanceScope).map((scope) => (
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                      <div className="space-y-0.5">
                        ...
                        <FormDescription>
                          Only allow attendance during specified time window
                        </FormDescription>
                      </div>
                      <FormControl>
                        <Switch
