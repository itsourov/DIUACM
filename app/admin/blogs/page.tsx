...
export default async function BlogsPage({
    ...
    const blogsData = data as { blogs: Blog[]; pagination: { currentPage: number; totalPages: number; totalCount: number; pageSize: number } } | undefined;
                        ...
                        <div className="flex flex-col items-center justify-center py-10 text-muted-foreground">
                            ...
                            {search ? (
                                <p className="mb-4 mt-2 text-center text-sm text-muted-foreground max-w-xs">
                                    No blog posts match &quot;{search}&quot;. Try a different search
                                    term or create a new blog post.
                                </p>
                            ) : (
                                <p className="mb-4 mt-2 text-center text-sm text-muted-foreground max-w-xs">
