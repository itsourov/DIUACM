import { ContestType, type NewContest, type NewTeam } from "@/db/schema";
import { z } from "zod";
...
// Schema for team creation/update - uses constraints from schema.ts
...
export type ContestInsertData = Omit<
  NewContest,
  "id" | "createdAt" | "updatedAt"
>;
export type TeamInsertData = Omit<NewTeam, "id" | "createdAt" | "updatedAt">;
