...
class RankList extends Component
{
    ...
    public function render(): Factory|View|Application|\Illuminate\View\View
    {
        ...
        $contests = cache()->remember($tracker->id . '_contests', 60 * 60 * 2, function () use ($tracker) {
        ...
        $users = cache()->remember('ranklist_' . $tracker->id, 60 * 60 * 2, function () use ($eventIds, $tracker, $eventWeights) {
