    ...
    for (const event of events) {
      ...
      const createdEvent = await prisma.event.create({
        data: {
          ...
          startingAt: new Date(event.starting_at.replace(" ", "T") + "Z"),
          endingAt: new Date(event.ending_at.replace(" ", "T") + "Z"),
          ...
          createdAt: new Date(event.created_at.replace(" ", "T") + "Z"),
          updatedAt: new Date(event.updated_at.replace(" ", "T") + "Z"),
        },
      });
