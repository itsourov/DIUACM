                ...
                <div class="inline-block min-w-full p-1.5 align-middle  child cursor-grab">
                    <div
                        ...
                        <div
                            ...
                            <div class="mt-2 bg-blue-100 border border-blue-200 text-sm text-blue-800 rounded-lg p-4 dark:bg-blue-800/10 dark:border-blue-900 dark:text-blue-500 w-fit" role="alert" tabindex="-1" aria-labelledby="hs-soft-color-info-label">
                                <span id="hs-soft-color-info-label" class="font-bold">Info</span> vjudge api is not working properly. sorry for the issue. we are working to fix it.
                            </div>
                        </div>
                        <!-- End Header -->
