    ...
    <div class="container mx-auto px-2 py-10 space-y-6">
        ...
        <x-card class="box space-y-5 prose-base">
            ...
            <ul style="list-style-type: circle;">
                ...
                <li><strong>Trainer&rsquo;s Classes</strong>: Senior competitive programmers and invited trainers
                    conduct classes, covering advanced topics to help members improve their algorithmic and
            ...
            <p><strong>Our Mission</strong><br>This website serves as a central platform to manage and streamline our
                activities, including tracking attendance for classes, contests, and events. As we grow, we plan to
                introduce new features such as score calculation, individual progress tracking, and more, to better
                support the development of our members and help them achieve their competitive programming goals.</p>
            <p><strong>Join Us</strong><br>Together, we strive to make DIU ACM a hub of excellence in competitive
                programming at Daffodil International University.<br>The DIU ACM Team</p>
