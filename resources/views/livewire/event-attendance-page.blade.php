	...
	<x-card class="py-6 bg-white space-y-3">
		...
		<div class=" space-y-1">
			...
			<div class="flex items-center gap-2">
				...
				<span class="inline-flex items-center gap-1">{{svg($event->type->getIcon(),'w-5 h-5')}}{{$event->type->getLabel()}}</span>
			</div>
			<div class="flex items-center gap-2">
				<p>
					<b>Organized for: </b>
				</p>
				<span class="inline-flex items-center gap-1">{{svg($event->organized_for->getIcon(),'w-5 h-5')}}{{$event->organized_for->getLabel()}}</span>
			</div>
			<div class="flex items-center gap-2">
				<p>
					<b>Starting Time: </b>
